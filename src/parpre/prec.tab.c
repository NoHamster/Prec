...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DEF = 3,                        /* DEF  */
  YYSYMBOL_PRA = 4,                        /* PRA  */
  YYSYMBOL_IFDEF = 5,                      /* IFDEF  */
  YYSYMBOL_IFNDEF = 6,                     /* IFNDEF  */
  YYSYMBOL_IF = 7,                         /* IF  */
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  "end of file", "error", "invalid token", "DEF", "PRA", "IFDEF",
  "IFNDEF", "IF", "ENDIF", "ELIF", "ELSE", "OTH", "INC", "COMMENT",
  "CONTENT", "$accept", "prg", "stmts", "stmt", YY_NULLPTR
  };
...
{
       0,     3,    13,    14,    16,    17,    18,     0,    17
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    15,    16,    17,    17,    18,    18,    18
};
...
#line 1387 "prec.tab.c"
    break;


#line 1391 "prec.tab.c"
